...
## Route Handlers
### 39 Route Handlers - Info
### 40 Route Handler - GET
### 41 Route Handlers - Params
### 42 Route Handlers - POST
...
- Warning: Unexpected space before function parentheses.  space-before-function-paren
  - `function foo()` is OK, but `function foo ()` is wrong, cos space after `foo` and `()`
